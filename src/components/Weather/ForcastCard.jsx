...
const ForcastCard = ({
  ...
  return (
    <div
      onClick={isDaily ? onClick : () => {}}
      className={`flex flex-col items-center rounded-xl p-2 flex-grow flex-shrink basis-0 bg-gradient-to-tl ${
        selected ? "from-slate-200 to-slate-300" : "from-slate-100 to-slate-200"
      }`}
    >
      <h3 className="-mb-px">
